...
const RandomM = () => {
  ...
  return (
    <div className='  relative tracking-wider text-white justify-evenly   items-center h-[300px] w-[100%] flex flex-col object-fill rbg' >
      <img className=' absolute object-cover opacity-75 w-[100%] z-[-1] h-[300px] ' src={'imageUrl'} alt=""/>
      <div className=' p-[1rem] text-left w-[100%]  justify-start  flex flex-col gap-[.3rem] ' >
      ...
      <Input className=' w-[100%]  '  value={value} onChange={debouncedSearch}
    ...
    />
        ...
        <Link to={`/searchresults/${value}`} className=' flex justify-center px-[5%] items-center text-[100%] font-semibold absolute right-[0%] top-[0%] text-center z-999 s-bg w-auto h-[100%] rounded-3xl ' >
          <div>
            Search
          </div>
        </Link>
